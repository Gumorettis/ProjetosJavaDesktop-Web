 ...
 * @author gusta
 */
@WebServlet(name = "DadosOcorrencia", urlPatterns = {"/DadosOcorrencia"})
public class DadosOcorrencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          //  request.setAttribute("ocorrencia", ocorrenciaDAO.listarOcorrencia());
            ...
            System.out.println("Problemas ao alistar Responsavel!"
                    + "\n Erro: " + ex.getMessage());
        }
    }
