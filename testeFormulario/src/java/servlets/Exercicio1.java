 ...
 * @author gusta
 */
@WebServlet(name = "Exercicio1", urlPatterns = {"/Exercicio1"})
public class Exercicio1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("nomeProdut", nomeProduto);
        ...
        request.getRequestDispatcher("ExercicioForm.jsp").forward(request, response);
    }
