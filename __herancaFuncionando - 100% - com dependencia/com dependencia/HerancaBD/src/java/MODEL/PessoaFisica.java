...
public class PessoaFisica extends Pessoa{
    ...
    protected int idade;
    protected Integer idPessoaFisica;
    ...
    public PessoaFisica(String cpf, int idade, Integer idPessoaFisica) {
        this.cpf = cpf;
        this.idade = idade;
        this.idPessoaFisica = idPessoaFisica;
    }

    public PessoaFisica(String cpf, int idade, Integer idPessoaFisica, int idPessoa, String nomePessoa, String endereco, int telefone, String tipo_pessoa, String login_pessoa, String senha_pessoa) {
