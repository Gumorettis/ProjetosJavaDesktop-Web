...
public class Processar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Double qtdHora = Double.parseDouble(request.getParameter("qtdHoras"));
        
        Salario oSalario = new Salario();
        
        oSalario.setNomeFuncionario(nome);
        oSalario.setValorHora(valorHora);
        oSalario.setQtdHorasTrab(qtdHora);
        
        request.setAttribute("salario", oSalario);
