...
public class processamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer n3 = Integer.parseInt(request.getParameter("nota3"));
        Integer n4 = Integer.parseInt(request.getParameter("nota4"));
        ...
        String mensagem = "Aluno: "+nome+ " sua média final é: "+media+ "  e sua situação é: "+situacao;
